...
I created a store that sells essentials for sleeping which are pillows and blankets. I chose this topic because I really enjoy napping and wanted to make my project about it as well. I made a super class that creates bedding with no argument and parameterized constructors. Through my superclass I created the base state of my objects and I addded on by making two subclasses, Pillow and Blanket, using inheritance I was able to make objects that had new attributes with the super class's instance variables. I believe that through this project I waas able to successfully create a store like real life that fufills the requirements.